...
public class AddQuestion extends JFrame {
	...
	public AddQuestion() {
		...
		lblAnswerIs_3.setBounds(134, 477, 295, 53);
		...
		correctAnswer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				idChoseen=  (int) correctAnswer.getSelectedItem();		
			}
		});
	...
	public void addQuestionAndCheck() {
		try {
			 boolean flage=false;
			 ans1=answer1txt.getSelectedText();
			 ans2=answer2txt.getSelectedText();
			 ans3=answer3txt.getSelectedText();
			 ans4=answer4txt.getSelectedText();
			 DifficultyLevel dl=(DifficultyLevel) difficulty.getSelectedItem();
			 idChoseen=(int) correctAnswer.getSelectedItem();
			//check empty fields
			 if(content.getSelectedText().isEmpty() ) {
			...
			if(idChoseen==1) {
				answer.put(1, new Answer(1,ans1,true));
			...
			if(idChoseen==2) {
				...
				answer.put(2, new Answer(2,ans2,true));
				answer.put(3, new Answer(3,ans3,false));
				answer.put(4, new Answer(4,ans4,false));
			}
			if(idChoseen==3) {
				answer.put(1, new Answer(1,ans1,false));
				answer.put(2, new Answer(2,ans2,false));
				answer.put(3, new Answer(3,ans3,true));
				answer.put(4, new Answer(4,ans4,false));
			}
			if(idChoseen==4) {
				answer.put(1, new Answer(1,ans1,false));
				answer.put(2, new Answer(2,ans2,false));
				answer.put(3, new Answer(3,ans3,false));
				answer.put(4, new Answer(4,ans4,true));
			}
			
			
			Question newQuestion=new Question(Main.system.getNumberOfQuestion()+1,content.getSelectedText(),dl,answer,"animal");
