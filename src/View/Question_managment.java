...
public class Question_managment extends JFrame {
	...
	public Question_managment() {
		...
		JLabel lblSelectAQuestion = new JLabel("Select a question ");
		...
		lblSelectAQuestion.setBounds(98, 145, 272, 57);
		...
		remove.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				idBox.removeItem(que.getContent());
		...
		idBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				idChoseen=(String) idBox.getSelectedItem();
		...
		idBox.setBounds(323, 155, 439, 37);
		getContentPane().add(idBox);
		
		
		//idBox2 is a Box that have a list of 4 number to choose the correct answer
		ArrayList<Integer> fourNumbers=new ArrayList<Integer>();
		fourNumbers.add(1);
		fourNumbers.add(2);
		fourNumbers.add(3);
		fourNumbers.add(4);
