...
public class Question implements Serializable{
	 ...
	 */
	public Question(String content, DifficultyLevel difficulty, HashMap<Integer,Answer> answers) {
		super();
	...
	public Question( String content, DifficultyLevel difficulty, HashMap<Integer,Answer> answers,String team) {
		super();
		this.content = content;
		this.difficulty = difficulty;
		this.answers = answers;
